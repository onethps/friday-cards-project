...
const PasswordRecovery = () => {
    ...
    const forgotError = useSelector<AppRootStateType, string>(state => state.forgotPassword.error)
    const isLoadingStatus = useSelector<AppRootStateType, boolean>(state => state.forgotPassword.isLoading)
    const isSendMessage = useSelector<AppRootStateType, boolean>(state => state.forgotPassword.isSendMessage)
